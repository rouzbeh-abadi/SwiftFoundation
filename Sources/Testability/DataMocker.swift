...
public struct DataMocker {
    ...
    internal static var shared = DataMocker()
    ...
    private(set) var mocks: [MockNetworkingData] = []
    ...
    private init() {
        ...
        URLProtocol.registerClass(DataURLProtocol.self)
    }
    ...
    public static func register(_ mock: MockNetworkingData) {
    ...
    static func mock(for request: URLRequest) -> MockNetworkingData? {
        shared.queue.sync {
